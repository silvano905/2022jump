...
export default function JumpStartServiceCookCounty() {
    return (
        <div>
            <Head>
            ...
            <div className={articleStyles.grid}>
                <div className={articleStyles.card}>
                    <Image src="/compressed-car-towing-jump-chicago-small.webp" alt="Battery jump start car service in Cook County, IL" width='400' height='300'/>
                </div>
                <div>
                    <h1 className={articleStyles.title}>Car jump service in Cook County, IL</h1>
                </div>
                <div className={articleStyles.card}>
                ...
                <div className={articleStyles.card}>
                    ...
                    <Image src="/jnc_comp.webp" alt="free jump start car service in Cook County, IL" width='300' height='300'/>
                ...
                <div className={articleStyles.card}>
                    <h3>Locations</h3>
                    <h4>Cook County, IL</h4>

                </div>

                <div className={articleStyles.card}>
                    <h3>About us</h3>
                    <p>Batteryjumpchicago has been in business for over 3 years in the Cook County area. We provide our customers with
                        the best car jump service in Cook County. Need a jump start? or your car won&apos;t start? we can help.
                    </p>
                    <div>
