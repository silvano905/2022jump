...
export default function JumpStartServiceDowntownChicago() {
    return (
        <div>
            <Head>
            ...
            <div className={articleStyles.grid}>
                <div className={articleStyles.card}>
                    <Image src="/compressed-car-towing-jump-chicago-small.webp" alt="Battery jump start car service in Downtown Chicago, IL" width='400' height='300'/>
                </div>
                <div>
                    <h1 className={articleStyles.title}>Car jump service in Downtown Chicago, IL</h1>
                </div>
                <div className={articleStyles.card}>
                ...
                <div className={articleStyles.card}>
                    ...
                    <Image src="/jnc_comp.webp" alt="free jump start car service in Downtown Chicago, IL" width='300' height='300'/>
                ...
                <div className={articleStyles.card}>
                    ...
                    <ul>
                        ...
                        <li>
                            <>
                                <h5>Location: Downtown Chicago, Illinois</h5>
                ...
                <div className={articleStyles.card}>
                    <h3>Locations</h3>
                    <h4>Downtown Chicago, IL</h4>

                </div>

                <div className={articleStyles.card}>
                    <h3>About us</h3>
                    <p>Batteryjumpchicago has been in business for over 3 years in the Downtown Chicago area. We provide our customers with
                        the best car jump service in Downtown Chicago. Need a jump start? or your car won&apos;t start? we can help. Top vehicle jump-start services in Downtown Chicago, IL.
                    </p>
                    <div>
                        ...
                        <h5>Downtown Chicago,IL 60402</h5>
                        <h5>(708)-548-9664</h5>
